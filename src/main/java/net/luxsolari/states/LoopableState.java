...
// Each state will implement the core methods of every state, such as update, render, and handleInput.
public interface LoopableState {
  ...
  // This method will handle the input of the game. In a text-based game, input should be handled first,
  // and then the game state should be updated and rendered.
  void handleInput();

  // This method will update the state of the game.
  // This happens second, since the inputs from the player will determine possible changes in the game state.
  void update();
  ...
  // This method will clean up the state of the game. It should be called once when the state is unloaded.
  void end();
}
